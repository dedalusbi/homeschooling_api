...
#
#     PHX_SERVER=true bin/homeschooling start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :homeschooling, HomeschoolingWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :homeschooling, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
...
#config :homeschooling, :s3_bucket, System.fetch_env!("AWS_S3_BUCKET") # ex: "educasa-uploads"
  ...
  #
  #     config :homeschooling, Homeschooling.Mailer,
